...
-   If using a SQL Login, make sure you have the account configured properly. Refer to [Management of Logins and Jobs for the Databases of an Availability Group (SQL Server)](../../../availability-groups/windows/logins-and-jobs-for-availability-group-databases?view=sql-server-2017).  
