...
-   If using a SQL Login, make sure you have the account configured properly. Refer to [Management of Logins and Jobs for the Databases of an Availability Group (SQL Server)](../../../database-engine/logins-and-jobs-for-availability-group-databases.md).  
