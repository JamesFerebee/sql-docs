...
<br>A database file is also set OFFLINE when a file is dropped. In the FULL RECOVERY model, the entry in sys.master_files persists until a transaction log backup is performed.</br>
